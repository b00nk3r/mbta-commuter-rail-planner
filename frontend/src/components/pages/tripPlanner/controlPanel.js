...
const TripPlannerControlPanel = ({
    ...
    return (
        <div
            className="
                absolute top-1/3 left-6 
                transform -translate-y-1/2 z-[700] 
                w-72 sm:w-80 
                ...
                <Link to="/tripSummaryPage">
                    <button
                        className="
                            ...
                            font-bold
                            bg-[rgb(160,68,118)]
                            hover:bg-[rgb(140,58,108)]
                            transition-colors duration-200
                            disabled:bg-[rgb(180,88,128)]
